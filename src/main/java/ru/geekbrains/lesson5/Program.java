...
/**
 * Интерфейс BLL (Business Logical Layer-Уровень бизнес-доступа 2й)
 */
interface BusinessLogicalLayer{
    Collection<Model3D> getAllModels();// можем получить все текстуры, все модели из базы данных
...
/**
 * Интерфейс DAC (Data Access Layer-Уровень доступа к данным 3й)
 */
interface DatabaseAccess{
    void addEntity(Entity entity);
    void removeEntity(Entity entity);
    Collection<Texture> getAllTextures(); // можем получить все текстуры, все модели из базы данных
...
//метод получения всех сущностей моей базы
...
interface Database{
    ...
    Collection<Entity> getAll(); //На базе данных получение всех 3Д моделей
}
